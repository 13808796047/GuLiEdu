...
from orgs.models import Org, Teacher
...
class Course(models.Model):
    ...
    level = models.CharField(choices=(('gj', '高级'), ('gj', '中级'), ('gj', '初级')), max_length=5, verbose_name='课程难度',
                             default='cj')
    ...
    teacher = models.ForeignKey(Teacher, verbose_name='所属讲师', on_delete=models.CASCADE)
