    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orgs.City', verbose_name='所在城市')),
            ],
            options={
                'verbose_name': '机构信息',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('avatar', models.ImageField(max_length=200, upload_to='teacher/', verbose_name='讲师头像')),
                ...
                ('gender', models.CharField(choices=[('female', '女'), ('male', '男')], default='male', max_length=10, verbose_name='讲师性别')),
                ('fav_num', models.IntegerField(default=0, verbose_name='收藏数')),
                ('versit_num', models.IntegerField(default=0, verbose_name='访问量')),
                ('created_time', models.DateTimeField(auto_now_add=True, verbose_name='创建时间')),
                ('work_company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='orgs.Org', verbose_name='所属机构')),
            ],
            options={
                'verbose_name': '讲师信息',
